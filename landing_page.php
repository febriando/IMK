  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            <a class="nav-link active" href="landing_page.php">Home <span class="sr-only">(current)</span></a>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <h1 class="display-4">We Will Give You <br><span>The Best</span> and <span>Good</span> Skincare</h1>
        <a href="menu_desire.php" class="btn btn-secondary tombol">Start</a>
      </div>
    </div>
    <!--Akhir Jumbotron-->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 info-panel">
          <div class="row">
            <div class="col-lg">
              <img class="float-left" src="desire logo.png" alt="desire">
              <h2>Requirement</h2>
              <p>Products required by the user.</p>
            </div>
            <div class="col-lg">
              <img class="float-left" src="problem logo.png" alt="desire">
              <h2>Problem</h2>
              <p>Facial problems will be searched.</p>
            </div>
            <div class="col-lg">
              <img class="float-left" src="search logo(2).jpg" alt="desire">
              <h2>Solution</h2>
              <p>provide some of solutions what user wants.</p>
            </div>
          </div>
        </div>
      </div>
